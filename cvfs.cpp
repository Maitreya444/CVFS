...
#define MAXINODE 5             //File creation is limited to 50

#define READ 1
#define WRITE 2                 

#define MAXFILESIZE 2048      //Max File size 

#define REGULAR 1           //Support for files
#define SPECIAL 2

#define START 0             //OFFSETS
#define CURRENT 1
#define END 2
...
typedef struct inode                //datastructures used in project
{
    char FileName[50];
    int InodeNumber;
    int FileSize;
...
void man(char * name)
{
    ...
    {
        printf("Description : Used to write into regular filr \n");
    ...
    {
        printf("Description : Used to open exisiting file\n");
...
printf("\n--------Statisatical Information about File--------\n");
printf("File name : %s\n", temp -> FileName);
printf("Inode Number %d\n", temp -> InodeNumber);
printf("File Size : %d\n", temp -> FileSize);
printf("Actual File Size : %d\n", temp -> FileActualSize);
...
printf("File Permsiion : Read & Write \n");
printf("----------------------------------------------------------\n\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        count = sscanf(str,"%s %s %s %s", command[0], command[1], command[2], command[3]);  //tokenizaation
        ...
        else if(count ==2)
        {
            if(strcmp(command [0], "stat")==0)
            {
                ...
                if(ret == -2)
                printf("ERROR : There is no such fiule \n");
                continue;
            }
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create")==0)
            {
                ...
                if(ret == -1)
                printf("ERROR : Incorect parametres \n");
                if(ret == -2)
            ...
            else if(strcmp(command[0],"read")==0)
            {
                ...
                if(fd == -1)
                {
                    printf("Error : Incorect paramerte\n");
                    continue;
                }
